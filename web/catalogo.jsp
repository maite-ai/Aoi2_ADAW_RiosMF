<%-- 
    Document   : catalogo
    Created on : 25 nov. 2020, 11:52:07
    Author     : Pei
--%>
            ...
            <div class="d-flex table-responsive">
                ...
                <%
                    ...
                    try {
                        ...
                        rs = sta.executeQuery("select * from producto order by codigo");
                        while(rs.next()){
                            %>
                            <tr align="center">
                                ...
                                <th>
                                    <a href="./verProd.jsp"><svg width="1.7em" height="1.7em" viewBox="0 0 16 16" class="bi bi-eye" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
