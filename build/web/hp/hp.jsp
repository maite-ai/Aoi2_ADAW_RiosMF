<%-- 
    Document   : hp
    Created on : 25 nov. 2020, 11:59:10
    Author     : Pei
--%>
        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">HP</li>
                </ol>
            </nav>
            ...
            <div class="d-flex table-responsive">
                ...
                <%
                    ...
                    try {
                        ...
                        rs = sta.executeQuery("select * from producto where marca = \"HP\" order by codigo");
                        while(rs.next()){
                            %>
                            <tr align="center">
