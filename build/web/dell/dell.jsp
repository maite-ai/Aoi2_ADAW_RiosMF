<%-- 
    Document   : dell
    Created on : 25 nov. 2020, 11:57:24
    Author     : Pei
--%>
        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Catálogo Dell</li>
                </ol>
            </nav>
            ...
            <div class="d-flex table-responsive">
                ...
                <%
                    ...
                    try {
                        ...
                        rs = sta.executeQuery("select * from producto where marca = \"Dell\" order by codigo");
                        while(rs.next()){
                            %>
                            <tr align="center">
