<%-- 
    Document   : adm-catalogo
    Created on : 25 nov. 2020, 10:41:01
    Author     : Pei
--%>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="col-auto">
                ...
                <p class="float-right"><a href="./addProd.jsp"><button type="submit" class="btn btn-success">Agregar Productos</button></a></p>
            </div>
            <br>
